...
public class Assign4Test extends TestCase {
  ...
  public void testRefP() {
    try {
        String input = "ref? (let x:= ref 4; y:= ref x; in !y)";
        allCheck("refP", "true", input );
        String input2 = "ref? (let x:= ref 4; y:= ref x; in !!y)";
  ...
  public void testRefCompare2() {
    try {
      ...
      noNameCheck("refCompare2", "true", input );
      nameCheck("refCompare2", "false", input );
  ...
  public void testRefCompare3() {
    try {
      String input = "let x := ref ref 10; y := x; in { !x <- 20; !y <- 30; x = y}";
      noNameCheck("refCompare3", "true", input );
      nameCheck("refCompare3", "false", input );
